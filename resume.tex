...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
        ...
        {\textbf{Certifications}: CREATIO Developer (2022), Terraform Associate (Expected Apr 2025)}
    }}
 \end{itemize}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Spearheaded the development of a web application using React, ASP.NET Core, and PostgreSQL for an E-commerce platform.}
        \resumeItem{Leveraged AWS services and CI/CD pipelines to reduce deployment time by 50\%.}
        \resumeItem{Architected and implemented CRM \& BPM solutions using ASP.NET and MS SQL.}
        \resumeItem{Deployed solution with Docker \& Kubernetes, reducing infrastructure cost by 30\%.}
      \resumeItemListEnd
      ...
      \resumeItemListStart
        ...
        \resumeItem{Built Jenkins-based CI/CD pipelines for automated deployments.}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItem {Built internal admin tooling for managing users, prescriptions, and orders to support streamlined operations.}
          \resumeItem {Achieved \textbf{99.9\% uptime} through resilient architecture and Kubernetes resource management.}
          \resumeItemListEnd
    \resumeSubHeadingListEnd
