...
\cvitem{}{\textbf{Languages}: C\#, JavaScript, TypeScript, Python, SQL, Golang}
\cvitem{}{\textbf{Frameworks/Libraries}: React, ASP.Net, Next.js, Flask, gRPC}
\cvitem{}{\textbf{DevOps/Cloud Technologies}: Docker, Kubernetes, AWS, Azure, Terraform}
\cvitem{}{\textbf{Databases}: PostgreSQL, MSSQL, MongoDB}
\cvitem{}{\textbf{Tools}: Git, Jenkins, CI/CD, SonarQube}
\cvitem{}{\textbf{Social Skills}: Team Leadership, Communication, Problem-Solving, Decision-Making}
